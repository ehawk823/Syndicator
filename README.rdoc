...
Clone the app to your local machine. Configure your application.yml file with the keys needed to run the methods in the PostsController. Create new event postings as an Admin user and the app will syndicate those posts!
